          ...
          <div className="relative overflow-hidden rounded-3xl bg-indigo-600 p-8 md:p-12 text-white shadow-2xl">
            <div className="relative z-10 max-w-2xl">
              ...
              <p className="text-lg text-indigo-100 mb-8 max-w-lg">
                Generates personalized quizzes, tracks your progress, and helps you learn faster with state-of-the-art AI.
              </p>
              <div className="flex flex-wrap gap-4">
                <Button asChild size="lg" className="bg-white text-indigo-600 hover:bg-indigo-50 font-bold h-14 px-8 rounded-xl shadow-lg shadow-indigo-900/20">
                    <Link href="/register">Start Learning Free</Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="border-indigo-300 text-white hover:bg-indigo-500 font-bold h-14 px-8 rounded-xl backdrop-blur-sm">
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-black text-gray-900 dark:text-white leading-none mt-1">
                        {courses.reduce((acc, c) => acc + (c._count?.questions || 0), 0)}
                      </p>
                    </div>
                  </div>
                </CardContent>
          ...
          {(isStudent || !user) && (
            <>
              <Card className="border-0 shadow-sm transition-shadow hover:shadow-md relative overflow-hidden group">
                {!user && <div className="absolute inset-0 bg-white/40 dark:bg-black/40 backdrop-blur-[1px] z-10 flex items-center justify-center">
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Answered</p>
                      <p className="text-2xl font-black text-gray-900 dark:text-white leading-none mt-1">
              ...
              <Card className="border-0 shadow-sm transition-shadow hover:shadow-md relative overflow-hidden group">
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Accuracy</p>
                      <p className="text-2xl font-black text-gray-900 dark:text-white leading-none mt-1">
              ...
              <CardContent className="pt-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                        <Badge variant={organization.plan === 'FREE' ? 'secondary' : 'default'} className="font-bold">
                        {organization.plan}
                        </Badge>
                    </div>
                  </div>
        ...
        <section>
          ...
          {isLoading ? (
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[1, 2, 3].map((i) => (
                <Card key={i} className="animate-pulse border-0 shadow-sm h-48" />
              ))}
            </div>
          ) : courses.length === 0 ? (
            <Card className="border-dashed border-2 border-gray-200 dark:border-gray-800 bg-transparent">
              <CardContent className="py-12 text-center">
                ...
                <p className="mt-4 text-gray-500 font-medium text-lg">No courses available yet</p>
                {(isAdmin || isInstructor) && (
          ...
          <section className="rounded-3xl bg-gradient-to-br from-gray-900 to-indigo-950 p-10 md:p-16 text-center text-white relative overflow-hidden">
            <div className="relative z-10 max-w-2xl mx-auto">
                ...
                <p className="text-gray-400 text-lg mb-10 leading-relaxed">
                    Join thousands of students and instructors using Cognify to save time, 
                    track progress, and achieve academic excellence.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <FeatureGate variant="prompt" title="Full Access" description="Create your free account today to unlock personalized quizzes and progress tracking.">
                        <Button size="lg" className="bg-indigo-600 hover:bg-indigo-700 font-bold h-14 px-10 rounded-xl shadow-xl shadow-indigo-900/40 w-full sm:w-auto">
