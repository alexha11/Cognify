              ...
              <div className="p-8 md:p-12 text-center space-y-8">
                <div className="max-w-md mx-auto space-y-4">
                  ...
                  <p className="text-gray-500 text-lg">
                    Instantly generate questions from any topic. Save hours of
                    manual work and create comprehensive assessments for your
                    students.
                  </p>
                </div>
                  ...
                  {[
                    {
                      ...
                      desc: "10 questions in under 30 seconds.",
                    },
                    {
                      title: "Any Topic",
                      desc: "From Quantum Physics to Pop Culture.",
                    },
                    {
                      title: "Always Correct",
                      desc: "Peer-reviewed style accuracy.",
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
                ...
                <div className="pt-4">
                  ...
                  >
                    <Button
                      size="lg"
                      className="px-10 h-14 text-lg font-bold bg-indigo-600 hover:bg-indigo-700 shadow-lg shadow-indigo-200 dark:shadow-none transition-all hover:scale-105 active:scale-95"
                    >
          ...
          <>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Select a course and enter a topic to generate multiple choice
                  questions
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {[
                    {
                      step: "1",
                      title: "Pick a Course",
                      desc: "Select where to add questions.",
                    },
                    {
                      step: "2",
                      title: "Define Topic",
                      desc: "AI tailoring to your subject.",
                    },
                    {
                      step: "3",
                      title: "Approve",
                      desc: "You have total control.",
                    },
                  ].map((s, i) => (
                    <div key={i} className="relative">
                      <div className="text-4xl font-black text-indigo-600/10 absolute -top-2 -left-2">
                        {s.step}
                      </div>
