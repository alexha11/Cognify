...
let BillingController = class BillingController {
    ...
    async createCheckout(dto, organizationId) {
        return this.billingService.createCheckoutSession(organizationId, dto.plan, dto.successUrl, dto.cancelUrl);
    }
    ...
    async createPortal(dto, organizationId) {
...
__decorate([
    ...
    __param(1, (0, decorators_1.CurrentUser)('organizationId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.CreatePortalDto, String]),
    __metadata("design:returntype", Promise)
