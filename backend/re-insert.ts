...
async function main() {
  ...
  // Delete all old questions for this course
  ...
  console.log(`Found ${questionsData.length} formatted questions. Inserting...`);
  ...
  console.log('Successfully re-inserted all questions with Math and Images!');
}
